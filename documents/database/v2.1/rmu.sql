...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2015 at 05:56 PM
...
`menu_id` bigint(20) NOT NULL,
  ...
  `menu_rating` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `master_menu` (`menu_id`, `menu_code`, `menu_name`, `menu_type`, `menu_price`, `menu_image_url`, `menu_rating`, `menu_status`, `menu_remarks`) VALUES
(1, 'NG', 'Nasi Goreng', 1, '10000.00', 'nasi-goreng.jpg', '5.00', 1, 'Available'),
(2, 'MA', 'Mie Ayam', 1, '15000.00', 'noodle.jpg', '4.50', 1, 'Available'),
(3, 'AQ', 'Aqua', 2, '6000.00', 'aqua.jpg', '4.20', 1, 'Available'),
(4, 'CC', 'Coca Cola', 2, '12000.00', 'coca-cola.jpg', '4.00', 1, 'Available'),
(5, 'BA', 'Bakso', 1, '13500.00', 'bakso.jpg', '3.80', 1, 'Available'),
(6, 'MB', 'Mie Ayam Bakso', 1, '20000.00', 'noodle.jpg', '5.00', 1, 'Available'),
(7, 'CC5ML', 'Coca Cola 5 Mili', 2, '10000.00', 'coca-cola.jpg', '4.50', 1, 'Available');
...
`version_id` bigint(20) NOT NULL,
  `version_table` varchar(255) DEFAULT NULL,
  `version_timestamp` timestamp NULL DEFAULT NULL,
  `version_status` smallint(6) DEFAULT NULL,
  `version_remarks` varchar(255) DEFAULT NULL
...
INSERT INTO `master_version` (`version_id`, `version_table`, `version_timestamp`, `version_status`, `version_remarks`) VALUES
(1, 'master_carriage', '2015-04-27 23:27:33', 1, 'Version Master Carriage'),
(2, 'master_menu', '2015-04-29 13:40:54', 1, 'Version Master Menu'),
(3, 'master_seat', '2015-04-28 11:33:14', 1, 'Version Master Seat'),
(4, 'master_train', '2015-04-28 10:18:38', 1, 'Version Master Train'),
(5, 'trx_order_header', '2015-04-29 04:18:38', 1, 'Version Transaction Order Header');
...
('OR0001', 1, 1, 1, 1, '2015-04-17 18:37:11', '25000.00', 4, 'Order', 0),
('OR0002', 1, 2, 2, 2, '2015-04-17 18:37:19', '15000.00', 3, 'Order', 0);
...
ALTER TABLE `master_carriage`
 ADD PRIMARY KEY (`carriage_id`), ADD UNIQUE KEY `carriage_code` (`carriage_code`);
...
ALTER TABLE `master_seat`
 ADD PRIMARY KEY (`seat_id`), ADD UNIQUE KEY `seat_code` (`seat_code`);

--
-- Indexes for table `master_train`
--
ALTER TABLE `master_train`
 ADD PRIMARY KEY (`train_id`), ADD UNIQUE KEY `train_code` (`train_code`);

--
-- Indexes for table `master_version`
--
ALTER TABLE `master_version`
...
--
ALTER TABLE `master_menu`
MODIFY `menu_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT for table `master_version`
--
ALTER TABLE `master_version`
MODIFY `version_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
