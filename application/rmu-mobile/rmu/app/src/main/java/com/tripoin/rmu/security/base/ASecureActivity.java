package com.tripoin.rmu.security.base;
...
import com.tripoin.rmu.rest.api.ISyncSecureResponse;
import com.tripoin.rmu.rest.base.ARestDialogGETAsyncTask;
import com.tripoin.rmu.rest.base.ARestDialogPOSTAsyncTask;
...
import com.tripoin.rmu.view.activity.base.ACustomActivity;
...
public abstract class ASecureActivity extends ACustomActivity implements ISyncSecureResponse, ISyncReloadConfiguration {
    ...
    public void setupActionBar() {
        ...
        actionBar.setBackgroundDrawable( new ColorDrawable( getResources().getColor( R.color.nliveo_green_colorPrimary ) ) );
